/**
 * Entry point for the `filament-cascade-gen` label — the cascading-parameter app.
 *
 * It mounts the JS the generator emits from baseline/Cascade.Blazor/App.razor (a parent cascading a
 * value that a composed child receives BY TYPE, without any attribute being passed). Like the other
 * feature labels it is NOT weighed or timed: it exists only so the DOM-contract oracle can click
 * #inc and assert the child's #depth advances 1 -> 2 -> 3 (decisions 29/30, "measure it";
 * decision 134).
 *
