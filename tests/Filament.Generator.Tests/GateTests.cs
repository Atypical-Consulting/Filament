...
public static class Generate
{
    ...
    public static string TryLockToTemp() => ToTemp(RepoPaths.TryLockRazor, "TryLock");

    public static string PositionalRecordToTemp() => ToTemp(RepoPaths.PositionalRecordRazor, "PositionalRecord");

    public static string LongCounterToTemp() => ToTemp(RepoPaths.LongCounterRazor, "LongCounter");
    ...
    public static string AsyncClickToTemp() => ToTemp(RepoPaths.AsyncClickRazor, "AsyncClick");

    public static string IfNestedMixedToTemp() => ToTemp(RepoPaths.IfNestedMixedRazor, "IfNestedMixed");

    public static string LinqAggregateToTemp() => ToTemp(RepoPaths.LinqAggregateRazor, "LinqAggregate");

    public static string SizedArrayToTemp() => ToTemp(RepoPaths.SizedArrayRazor, "SizedArray");

    public static string AsyncResultToTemp() => ToTemp(RepoPaths.AsyncResultRazor, "AsyncResult");
    ...
    public static string RowActionsToTemp() => ToTemp(RepoPaths.RowActionsRazor, "RowActions");
    ...
    public static string GenericToTemp() => ToTemp(RepoPaths.GenericRazor, "Generic");
