// GENERATED by Filament.Generator from IfElse.razor. DO NOT EDIT.
//
...
export function mount(target) {
  ...
  function ifBody0_2() {
    ...
    _el4.id = 'c';
    insert(_el4, document.createTextNode('c'));
    return _el4;
  }
  list(_el0, () => (n.value === 0) ? [0] : (n.value === 1) ? [1] : [2], (i) => i, (i) => i === 0 ? ifBody0_0() : i === 1 ? ifBody0_1() : ifBody0_2(), _if0);
